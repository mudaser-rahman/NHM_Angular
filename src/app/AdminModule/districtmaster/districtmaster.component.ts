...
export class DistrictmasterComponent {
  ...
  public dataSource = new MatTableDataSource<DistrictMaster>();
...
input: any;
displayedColumns: string[] = ['slNo', 'State', 'District', 'Action'];
          ...
          getcomponentmaster(subcategory3id:string) {
           // alert("check village");
            ...
            GetBeneficearydetails() {
              ...
              this.adminservicesService.GetAllBeneficearydata(this.statecd, this.yearcd).subscribe((result: any) => {
                this.data = result;
