...
@Component({
  selector: 'app-odofpcomponentselection',
  templateUrl: './odofpcomponentselection.component.html',
  styleUrls: ['./odofpcomponentselection.component.css']
})
export class ODOFPComponentselectionComponent {
  ...
  public dataSource = new MatTableDataSource<ComponentSelectionmaster>();
...
this.adminservicesService.GetStatemaster().subscribe((resultdistrictmaster) => {
  ...
  console.log(this.selectUserType, 'statemaster');
      ...
      GetODOFPComponentselection() {   
        this.adminservicesService.GetOdofpcomponentselectionmaster(this.statecd, this.yearcd).subscribe((data: any) => {
         
          this.dataSource.data = data as ComponentSelectionmaster[];
      ...
      GetODOFPComponentselectiondata() {   
        this.adminservicesService.GetOdofpcomponentselectionmaster(this.statecd, this.yearcd).subscribe((data: any) => {
...
PostODOFPComponentmaster()
{

this.addcomponentselection.State_Code=this.statecd;
this.addcomponentselection.Financial_Year= this.yearcd
this.addcomponentselection.Component_Code= "A1024"
this.addcomponentselection.Category= "1"
this.addcomponentselection.SubCategory1="1011"
this.addcomponentselection.SubCategory2="1011"
this.addcomponentselection.SubCategory3="10011"
this.addcomponentselection.Component_Name="demo";


this.adminservicesService.PostODOFPComponentselectionmaster(this.addcomponentselection).subscribe((result: any) => {
  this.updatedistrictmaster = result;
  console.log(this.updatedistrictmaster, 'PostODOFPcomponentmaster');   
