...
@Component({
  selector: 'app-hq-data-physicaltargets',
  templateUrl: './hq-data-physicaltargets.component.html',
  styleUrls: ['./hq-data-physicaltargets.component.css']
})
export class HQDataPhysicaltargetsComponent {
...
this.adminservicesService.getmonths().subscribe((resultdistrictmaster) => {
  ...
  console.log(this.selectmonthmaster, 'months');
      ...
      GetStatewiseTargets() {   
        this.adminservicesService.GetStateWisephysicaltargets(this.statecd, this.monthcd, this.yearcd).subscribe((data: any) => {
