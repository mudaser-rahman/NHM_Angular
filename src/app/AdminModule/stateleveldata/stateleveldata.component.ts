...
@Component({
  selector: 'app-stateleveldata',
  templateUrl: './stateleveldata.component.html',
  styleUrls: ['./stateleveldata.component.css']
})
export class StateleveldataComponent {
...
this.adminservicesService.GetStatemaster().subscribe((resultdistrictmaster) => {
 ...
 getstatedataentrystatus()
 {
    
  this.adminservicesService.Getstateleveldata(this.yearcd).subscribe((result: any) => {
 ...
 Getsprilldataentrystatus()
 {
    
  this.adminservicesService.GetSprillstatedata(this.yearcd).subscribe((result: any) => {
    
    this.data = result;
    console.log(this.data, 'sprillleveldata');
  });
