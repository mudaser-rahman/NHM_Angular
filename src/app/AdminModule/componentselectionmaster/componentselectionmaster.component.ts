...
@Component({
  selector: 'app-componentselectionmaster',
  templateUrl: './componentselectionmaster.component.html',
  styleUrls: ['./componentselectionmaster.component.css']
})
export class ComponentselectionmasterComponent {
...
this.adminservicesService.GetStatemaster().subscribe((resultdistrictmaster) => {
  ...
  console.log(this.selectUserType, 'statemaster');
      ...
      GetSelectioncomponent() {   
        this.adminservicesService.GetSelectComponenetmaster(this.statecd, this.yearcd, this.choicecd).subscribe((data: any) => {
